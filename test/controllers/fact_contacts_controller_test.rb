...
class FactContactsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact_contact" do
    assert_difference('FactContact.count') do
      post fact_contacts_url, params: { fact_contact: { company_name: @fact_contact.company_name, creation_date: @fact_contact.creation_date, email: @fact_contact.email, project_name: @fact_contact.project_name } }
    end
  ...
  test "should update fact_contact" do
    patch fact_contact_url(@fact_contact), params: { fact_contact: { company_name: @fact_contact.company_name, creation_date: @fact_contact.creation_date, email: @fact_contact.email, project_name: @fact_contact.project_name } }
