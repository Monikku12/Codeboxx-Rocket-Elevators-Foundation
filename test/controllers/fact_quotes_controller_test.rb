...
class FactQuotesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact_quote" do
    assert_difference('FactQuote.count') do
      post fact_quotes_url, params: { fact_quote: { Nb_Elevator: @fact_quote.Nb_Elevator, company_name: @fact_quote.company_name, creation_date: @fact_quote.creation_date, quote_email: @fact_quote.quote_email } }
    end
  ...
  test "should update fact_quote" do
    patch fact_quote_url(@fact_quote), params: { fact_quote: { Nb_Elevator: @fact_quote.Nb_Elevator, company_name: @fact_quote.company_name, creation_date: @fact_quote.creation_date, quote_email: @fact_quote.quote_email } }
