...
class FactElevatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fact_elevator" do
    assert_difference('FactElevator.count') do
      post fact_elevators_url, params: { fact_elevator: { building_city: @fact_elevator.building_city, building_id: @fact_elevator.building_id, customer_id: @fact_elevator.customer_id, date_of_commissioning: @fact_elevator.date_of_commissioning, serial_number: @fact_elevator.serial_number } }
    end
  ...
  test "should update fact_elevator" do
    patch fact_elevator_url(@fact_elevator), params: { fact_elevator: { building_city: @fact_elevator.building_city, building_id: @fact_elevator.building_id, customer_id: @fact_elevator.customer_id, date_of_commissioning: @fact_elevator.date_of_commissioning, serial_number: @fact_elevator.serial_number } }
