class DimCustomersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @dim_customer.save
        format.html { redirect_to dim_customer_url(@dim_customer), notice: "Dim customer was successfully created." }
  ...
  def update
    respond_to do |format|
      if @dim_customer.update(dim_customer_params)
        format.html { redirect_to dim_customer_url(@dim_customer), notice: "Dim customer was successfully updated." }
  ...
  private
    ...
    def dim_customer_params
      params.require(:dim_customer).permit(:creation_date, :company_name, :full_name, :company_contact_email, :Nb_Elevator, :customer_city)
    end
end
