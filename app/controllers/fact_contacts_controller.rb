class FactContactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fact_contact.save
        format.html { redirect_to fact_contact_url(@fact_contact), notice: "Fact contact was successfully created." }
  ...
  def update
    respond_to do |format|
      if @fact_contact.update(fact_contact_params)
        format.html { redirect_to fact_contact_url(@fact_contact), notice: "Fact contact was successfully updated." }
  ...
  private
    ...
    def fact_contact_params
      params.require(:fact_contact).permit(:creation_date, :company_name, :email, :project_name)
    end
end
