class FactQuotesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fact_quote.save
        format.html { redirect_to fact_quote_url(@fact_quote), notice: "Fact quote was successfully created." }
  ...
  def update
    respond_to do |format|
      if @fact_quote.update(fact_quote_params)
        format.html { redirect_to fact_quote_url(@fact_quote), notice: "Fact quote was successfully updated." }
  ...
  private
    ...
    def fact_quote_params
      params.require(:fact_quote).permit(:creation_date, :company_name, :quote_email, :Nb_Elevator)
    end
end
