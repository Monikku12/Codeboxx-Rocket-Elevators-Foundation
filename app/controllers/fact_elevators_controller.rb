class FactElevatorsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fact_elevator.save
        format.html { redirect_to fact_elevator_url(@fact_elevator), notice: "Fact elevator was successfully created." }
  ...
  def update
    respond_to do |format|
      if @fact_elevator.update(fact_elevator_params)
        format.html { redirect_to fact_elevator_url(@fact_elevator), notice: "Fact elevator was successfully updated." }
  ...
  private
    ...
    def fact_elevator_params
      params.require(:fact_elevator).permit(:serial_number, :date_of_commissioning, :building_id, :customer_id, :building_city)
    end
end
